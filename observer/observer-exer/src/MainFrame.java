    ...
    public MainFrame() {
        ...
        red.addActionListener(l -> {
            if (Ball.getCount() < Ball.TOTAL_NUM) {
                mainPanel.addBallToPanel(new RedBall(Color.RED, 3, 2, 60, mainPanel, mainPanel.getWhiteBall()));
        ...
        blue.addActionListener(l -> {
            if (Ball.getCount() < Ball.TOTAL_NUM) {
                mainPanel.addBallToPanel(new BlueBall(Color.BLUE, 6, 4, 60, mainPanel, mainPanel.getWhiteBall()));
